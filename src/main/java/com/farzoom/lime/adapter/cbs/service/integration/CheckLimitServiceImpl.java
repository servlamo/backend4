...
import com.farzoom.lime.adapter.cbs.service.integration.model.checklimit.request.CheckLimitRequest.BankSvcRq;
import com.farzoom.lime.adapter.cbs.service.integration.model.checklimit.request.CurrencyAmount;
import com.farzoom.lime.adapter.cbs.service.integration.model.checklimit.request.Date;
import com.farzoom.lime.adapter.cbs.service.integration.model.checklimit.request.ServerInfoType;
...
@Service
public class CheckLimitServiceImpl implements IntegrationService<CheckLimitRequest> {
    private static final BigDecimal COINS = new BigDecimal(100);

    @Override
    public CheckLimitRequest createRequest(Order order, Company principal, Product product) {
...
//                        setStateRegPrimeNum(ben.getOGRN());
    ...
    private static BankSvcRq.ProdInfo fillProdInfo(com.farzoom.common.persistence.es.model.Product product) {
    ...
    private static ServerInfoType fillServerInfo() {
        return new ServerInfoType() {{
            ...
            setMsgReceiver("IBSO");
            setServerDt(getNow());
            setMsgType("OrgLimitCheckInqRq");
            setBpId("MTS_CHECK_LIMIT");
        }};
    }
}
